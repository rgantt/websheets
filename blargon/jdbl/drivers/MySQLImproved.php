...
/**
* $Id: MySQLImproved.php,v 1.1.1.1 2005/07/06 17:28:53 blargon Exp $
*
...
*/
class MySQLImproved extends Database
{
        /**
	* The current command for MySQLi. Changes with every method call
	*
	* @var
	*/
	...
	*/
        ...
        {
		$linkId = mysqli_connect( $login['host'], $login['user'], $login['pass'] );
		if( $linkId )
		{
			$this->linkId = $linkId;
			return $this->linkId;
	...
	*/
        ...
        {
                $queryId = mysqli_query( $this->linkId, $query );
                if( !$queryId )
                {
