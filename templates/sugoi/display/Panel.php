...
<div align="left" style="margin-top:15px; width:120px;">
	<div align="center" style="font-family:arial; background-color:#C5C9CA; color:#ffffff;">NAVIGATION</div>
	<div class="panelMenu" style="background-color:#ffffff; border:1px dashed #AAAAAA;">@var->menu;</div>
</div>
</td>
